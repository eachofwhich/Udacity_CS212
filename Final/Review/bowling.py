...
def bowling(balls, frame = 0):
    ...
    if balls[0] is 10: return 10 + sum(balls[1:3]) + bowling(balls[1:], frame)
    if balls[0] + balls[1] >= 10: return 10 + sum(balls[2:3]) + bowling(balls[2:], frame)
    if balls[0] + balls[1] < 10: return sum(balls[:2]) + bowling(balls[2:], frame)
