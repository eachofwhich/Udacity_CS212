...
def logic_puzzle():
	...
	hamming, knuth, minsky, simon, wilkes = next(result)

	day_map = {hamming: 'Hamming', knuth: 'Knuth', minsky: 'Minsky', simon: 'Simon', wilkes: 'Wilkes'}
	return [person for key, person in sorted(day_map.items())]
